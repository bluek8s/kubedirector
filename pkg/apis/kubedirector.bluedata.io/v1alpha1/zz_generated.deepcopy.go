...
func (in *AppSpec) DeepCopyInto(out *AppSpec) {
	*out = *in
	out.Label = in.Label
	out.Image = in.Image
	in.JSONSetupPackage.DeepCopyInto(&out.JSONSetupPackage)
	if in.Services != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *JSONSetupPackage) DeepCopyInto(out *JSONSetupPackage) {
	*out = *in
	if in.SetupPackage != nil {
		in, out := &in.SetupPackage, &out.SetupPackage
		if *in == nil {
			*out = nil
		} else {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new JSONSetupPackage.
func (in *JSONSetupPackage) DeepCopy() *JSONSetupPackage {
	if in == nil {
		return nil
	}
	out := new(JSONSetupPackage)
	in.DeepCopyInto(out)
	return out
}
