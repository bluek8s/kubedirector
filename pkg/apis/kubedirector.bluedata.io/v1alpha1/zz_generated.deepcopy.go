...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SetupPacakgeURL) DeepCopyInto(out *SetupPacakgeURL) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SetupPacakgeURL.
func (in *SetupPacakgeURL) DeepCopy() *SetupPacakgeURL {
	if in == nil {
		return nil
	}
	out := new(SetupPacakgeURL)
	in.DeepCopyInto(out)
	return out
}
